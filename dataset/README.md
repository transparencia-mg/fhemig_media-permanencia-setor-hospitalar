...
Issues: Para iniciar uma discussão sobre melhorias na documentação. Pull requests: Para sugerir uma alteração concreta na documentação. Todas as contribuições são bem vindas. Alguns exemplos são:
Indicação de expressões imprecisas presentes na documentação; Sugestões para inclusão de descrições em campos específicos; Sugestões para clareza na organização das ideias; Correção de erros de ortografia e gramática. Além disso, fique a vontade para utilizar os demais canais oficiais de atendimento do Poder Executivo Estadual:
